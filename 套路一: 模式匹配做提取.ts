...
type GetInstanceType<ConstructorType extends new (...arg: any[]) => any> = ConstructorType extends new (
  ...arg: any
) => infer InstanceType
  ? InstanceType
  : any;
...
// 那同样也可以提取构造器的参数类型
type GetInstanceParameters<ConstructorType extends new (...args: any) => any> = ConstructorType extends new (
